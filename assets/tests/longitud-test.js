...
suite('temperature', function() {
    ...
    test("Longitud debe ser hija de la clase Medida", function() {
        var herencia = new Longitud('23m');
        expect(herencia).to.be.instanceof(Medida);
    });

    test("Debería convertir Metros a Pulgadas", function() {
    ...
    test("Debería convertir Pulgadas a Metros", function() {
    ...
    test("Debe aceptar un valor y guardarlo con tipo 'Metros'", function() {
        var metros = new Metros(25);
        expect(metros.getValue()).to.equal(25);
        expect(metros.getType()).to.equal('Metros');
    });

    test("Una instancia de 'Metros' debe ser hija de la clase Longitud", function() {
        var metros = new Metros(25);
        expect(metros).to.be.instanceof(Longitud);
    });

    test("Debe aceptar un valor y guardarlo con tipo 'Pulgadas'", function() {
